...
namespace Mogoo.Pool
{
    public class ObjectPoolData
    {
        ...
        public ObjectPoolData(GameObject gameObject, GameObject poolObject)
        {
    ...
    {
        private readonly Dictionary<string, ObjectPoolData> _pools = new Dictionary<string, ObjectPoolData>();
        ...
        {
            if (_poolObject == null) _poolObject = new GameObject("ObjectPoolManager");
            ...
            {
                _pools.Add(name, new ObjectPoolData(gameObject, _poolObject));
            }
        }
